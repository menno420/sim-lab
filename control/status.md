...
notes: seeded 2026-07-10 by the dispatch copilot (superbot round-3 part-4; recipe: part-4 brief §3, third consumer). Coordinator NOT booted — this heartbeat is the seed record, not a wake. First wake must pull idea-engine PROPOSAL 001 (verified waiting, sim-ready, 18:05Z) — the Q-0264 pipeline's end-to-end proof. Routine to arm at boot: "sim-lab 2-hourly standing wake", cron 0 1-23/2 * * * (ODD hours — reads the Idea Engine's even-hour output one hour later; manager reads at :30).
